...
import 'package:side_hospital_desktop_app/authentication/admin_login.dart';
...
import 'package:side_hospital_desktop_app/screens/splash.dart';
...
void main() async {
  ...
  window_size.getWindowInfo().then((window) {
    ...
    if (screen != null) {
      ...
      window_size.setWindowMinSize(Size(1.01 * width, 1.0 * height));
